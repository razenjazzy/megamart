...
<div class="aiz-demo-nav">
    ...
    <div class="aiz-demo-nav-links">
        <a href="https://golpocom.com/docs/active-ecommerce-cms/" class="aiz-demo-nav-item" target="_blank">
            ...
            <div class="row gutters-16">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-grocery/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-electronics/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-fashion/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-automobile/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-furniture/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-medical/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-sports/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-construction/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://localhost/megamart/web-megamart/" target="_blank" class="h-100 w-100">
