...
@if (addon_is_activated('backup_restore_system') && auth()->user()->can('backup_restore_system'))
    <li class="aiz-side-nav-item">
        <a href="{{route('backups')}}" class="aiz-side-nav-link">
            {{--                            <i class="las la-database aiz-side-nav-icon"></i>--}}

            <div class="aiz-side-nav-icon">
                <svg fill="#000000" width="18" height="18" viewBox="0 0 36 36"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
